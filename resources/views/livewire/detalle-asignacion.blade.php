    ...
    <ul class="my-4 space-y-3">
        <li>
            <a href="#" class="flex items-center p-4 mb-5 text-base border-none font-bold text-white rounded-lg bg-green-800 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)]">
                ...
                <span class="flex-1 ml-3 text-sm whitespace-nowrap">Masaje hidratante para manos y pies</span>
                <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-2xl font-extrabold text-white ">$30.00</span>
            </a>
        </li>
            <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Adicionales:</p>
        <li>
            <a href="#" class="flex items-center p-2 px-5 text-base font-bold text-white rounded-lg bg-green-500 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)]">
                ...
                <span class="flex-1 ml-3 text-xs whitespace-nowrap">Manicure</span>
                <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-lg font-extrabold text-white ">$30.00</span>
            </a>
        </li>
        <li>
            <a href="#" class="flex items-center p-2 px-5 text-base font-bold text-white rounded-lg bg-green-500 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)]">
                ...
                <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-lg font-extrabold text-white ">$60.00</span>
            </a>
        </li>

    </ul>
    <div class="sm:mt-2">
        <button type="button" wire:click="cancel()" class="inline-flex w-full justify-center rounded-lg bg-red-600 px-3 py-3 mt-10 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Cerrar servicio</button>
    </div>
</div>
