    ...
    <div class="grid grid-cols-2 gap-2">
        <div class="w-full max-w-2xl max-h-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
            ...
            <ul class="my-4 space-y-3">
                ...
                <a href="#" class="flex items-center p-2 px-5 text-base font-bold text-white rounded-lg bg-green-600 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)]">
                    ...
                    <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 mr-5 text-lg font-extrabold text-white ">Bsd. {{ $total_vista * $tasa }}</span>
                </a>
                </li>
            </ul>
        </div>
        <div class="w-full max-w-2xl max-h-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="mt-8 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="px-2 {{ $usd_hidden }}">
                        <p class="text-sm font-normal text-gray-500 dark:text-gray-400 ">Monto a pagar en USD:</p>
                        <x-inputs.currency icon="currency-dollar" wire:model="dolares"/>
                    </div>
                    <div class="px-2 {{ $bsd_hidden }}">
                        <p class="text-sm font-normal text-gray-500 dark:text-gray-400 ">En bolivares:</p>
                        <x-inputs.currency thousands="." decimal="," precision="4" wire:model="bolivares"/>
                    </div>
                </div>
                <div class="sm:mt-2">
