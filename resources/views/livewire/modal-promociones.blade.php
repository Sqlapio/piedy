            ...
            <div class="mt-10 text-center sm:mt-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-1 mb-4 mt-5">
                    ...
                    <div class="p-2">
                        ...
                        <x-select label="Select Statuses" placeholder="Select many statuses" multiselect :options="['Active', 'Pending', 'Stuck', 'Done']" wire:model.defer="servicios"/>
                    </div>
                </div>
            </div>
        </div>
    <div class="sm:mt-6">
        <button type="button" wire:click="asignar_sevicio()" class="mt-20 inline-flex w-full justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Asignar técnico</button>
    </div>
</div>
