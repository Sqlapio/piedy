<div class="py-8 my-auto">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        {{-- Clientes --}}
        <div class="p-6 rounded-lg" style="background-image: url('/images/clientes.jpg');
        ...
        {{-- Empleados --}}
        <div class="p-6 rounded-lg" style="background-image: url('/images/empleados.jpg');
        background-size: cover;">
            <a href="">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
        ...
        {{-- Cabinas --}}
        <div class="p-6 rounded-lg" style="background-image: url('/images/cabinas.jpg');
        background-size: cover;">
            <a href="">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
            ...
            <div class="ml-12 text-right">
                <div class="mt-2 text-3xl text-black leading-7 font-bold">
                    ...
                    <div class="mt-3 text-right text-md font-semibold text-black">
                        <div>Activacion de cabinas de trabajo</div>
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 mb-4">
        {{-- Productos --}}
        <div class="p-6 rounded-lg" style="background-image: url('https://cdn.pixabay.com/photo/2017/03/25/18/06/color-2174066_640.png');
        background-size: cover;">
            <a href="">
            <div class="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
