        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 h-60">
            ...
            <div>
                <a href="{{ route('gift-card') }}">
                    <div class="p-6 rounded-lg object-cover" style="background-image: url('{{ asset('images/TARJETA-ROSA3.png') }}'); background-size: cover;">
            ...
            <div>
                <a href="{{ route('membresia') }}">
                    <div class=" p-6 rounded-lg" style="background-image: url('{{ asset('images/aTARJETA-VIP-2.png') }}');background-size: cover;">
                        {{-- <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
