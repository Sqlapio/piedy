            ...
            <div class="px-4">
                ...
                <div class="flex justify-end">
                    <div class="flex flex-col justify-end mt-5">
                        <p class="font-bold text-[10px] text-end text-black uppercase">Reporte Nro.{{ $nro_reporte }}</p>
                ...
                <div class="flex flex-col">
                    <p class="mt-5 text-[10px] font-bold text-black uppercase">Empleado: {{ $nombre }}</p>
                    <p class="mb-4 text-[10px] font-bold text-black uppercase">C.I.: {{ $cedula }}</p>
                </div>
                ...
                <div class="grid md:grid-cols-2 sm:gap-2 md:gap-2">
                    ...
                    <div>
                        <div class="flex justify-between items-center max-w-sm px-2 py-1 bg-white border border-[#349fda] rounded-lg shadow">
                            <div class="">
                                <p class="text-[10px] font-normal text-black uppercase">Total de Servicios</p>
                            </div>
                            <div>
                                <span class="text-[10px] inline-flex items-center px-2 py-1 mr-auto font-bold text-center text-[#349fda] align-baseline rounded-lg border border-[#349fda]">
                    ...
                    <div>
                        <div class="flex justify-between items-center max-w-sm px-2 py-1 bg-white border border-[#349fda] rounded-lg shadow">
                            <div class="">
                                <p class="text-[10px] font-normal text-black uppercase">Eficiencia</p>
                            </div>
                            <div>
                                <span class="text-[10px] inline-flex items-center px-2 py-1 mr-auto font-bold text-center text-[#349fda] align-baseline rounded-lg border border-[#349fda]">
                                    <svg class="w-4 h-4 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div>
                        <div class="flex justify-between items-center max-w-sm px-2 py-1 bg-white border border-[#349fda] rounded-lg shadow">
                            <div class="">
                                <p class="text-[10px] font-normal text-black uppercase">Duracion de servicios</p>
                            </div>
                            <div>
                                <span class="text-[10px] inline-flex items-center px-2 py-1 mr-auto font-bold text-center text-[#349fda] align-baseline rounded-lg border border-[#349fda]">
                                    <svg class="w-4 h-4 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div>
                        <div class="flex justify-between items-center max-w-sm px-2 py-1 bg-white border border-[#349fda] rounded-lg shadow">
                            <div class="">
                                <p class="text-[10px] font-normal text-black uppercase">dias laborales</p>
                            </div>
                            <div>
                                <span class="text-[10px] inline-flex items-center px-2 py-1 mr-auto font-bold text-center text-[#349fda] align-baseline rounded-lg border border-[#349fda]">
                                    <svg class="w-4 h-4 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class="grid md:grid-cols-2 sm:gap-2 md:gap-2 mt-3">
                    ...
                    <div>
                        <div class="flex justify-between items-center max-w-sm p-1 bg-white border border-green-500 rounded-lg shadow">
                            <div class="">
                                <p class="text-[10px] font-extrabold text-black uppercase">Total Dolares</p>
                            </div>
                            <div>
                                <span class="text-[10px] inline-flex items-center px-2 py-1 mr-auto font-extrabold text-center text-green-500 align-baseline rounded-lg border border-green-500">
                                    <svg class="w-4 h-4 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <div>
                        <div class="flex justify-between items-center max-w-sm p-1 bg-white border border-green-500 rounded-lg shadow">
                            <div class="">
                                <p class="text-[10px] font-extrabold text-black uppercase">Total Bolivares</p>
                            </div>
                            <div>
                                <span class="text-[10px] inline-flex items-center px-2 py-1 mr-auto font-extrabold text-center text-green-500 align-baseline rounded-lg border border-green-500">
                                    <svg class="w-4 h-4 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <!-- Tabla de servicios -->
                <div class="flex mt-5">
                    <p class="mt-5 mb-4 text-[10px] font-bold text-black uppercase">Detalle de servicios</p>
                </div>

                <div class="relative overflow-x-auto shadow-md rounded-lg border">
                    <table class="table-fixed w-full text-[10px] text-left text-gray-500 dark:text-gray-400">
