<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <label class="opacity-60 mb-1 block text-sm font-medium text-italblue">Contraseña anterior</label>
        ...
        <div class="col-span-6 sm:col-span-4">
            <label class="opacity-60 mb-1 block text-sm font-medium text-italblue">Nueva contraseña</label>
        ...
        <div class="col-span-6 sm:col-span-4">
            <label class="opacity-60 mb-1 block text-sm font-medium text-italblue">Repita su contraseña</label>
