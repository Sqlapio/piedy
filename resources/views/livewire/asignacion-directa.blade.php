    ...
    <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all w-full sm:p-6">
        <div>
            ...
            <div class="mt-10 text-center sm:mt-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-4 mb-4 mt-4">
                    <div class="p-2">
                    ...
                    <div class="p-2">
                        <label class="opacity-60 mb-1 block text-md font-extrabold text-green-700 text-italblue text-left">Cliente</label>
                    ...
                    <div class="p-2">
                        <label class="opacity-60 mb-1 block text-md font-extrabold text-green-700 text-italblue text-left">Servicio</label>
