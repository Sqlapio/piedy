    ...
    <div class="grid grid-cols-2 gap-2">
        ...
        <div class="w-full max-h-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
            ...
            <footer>
                ...
                <div class="sm:mt-2">
                    <button type="button" wire:click="agregar_servicio()" class="inline-flex w-full justify-center rounded-lg bg-green-500 px-3 py-3 mt-14 text-sm font-semibold text-white shadow-sm">
