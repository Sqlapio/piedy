...
<div class="py-1 my-auto">
    ...
    @if(Auth::user()->tipo_usuario == 'gerente')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-3">
            ...
            {{-- Productos --}}
            <div wire:click="valida_tasa({{ 4 }})" class="p-6 rounded-lg" style="background-image: url('https://cdn.pixabay.com/photo/2017/03/25/18/06/color-2174066_640.png'); background-size: cover;">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
        ...
        {{-- Segunda linea --}}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 p-3">
            ...
            {{-- gastos --}}
            <div wire:click="valida_tasa({{ 7 }})" class="p-6 rounded-lg" style="background-image: url('https://img.freepik.com/fotos-premium/papel-tapiz-triangulo-abstracto-colores-pastel-claros-coloridos-banner-panorama-generativo-ai_699690-19035.jpg');background-size: cover;">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
            ...
            {{-- Cierre diario --}}
            <div wire:click="valida_tasa({{ 8 }})" class="p-6 rounded-lg" style="background-image: url('https://elucubracion.com/wp-content/uploads/2014/05/fondo-abstracto-1.png');background-size: cover;">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-20">
