...
<div class="py-5 my-auto sm:px-5 md:px-10 lg:px-20">
    ...
    <div class="grid grid-cols-2 gap-4 p-3">
        {{-- TASA BCV --}}
        <div class="cursor-pointer flex items-center border p-1 rounded-xl shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]" onclick="Livewire.dispatch('openModal', { component: 'tasa-bcv' })" style="background-image: url('https://media.istockphoto.com/id/624878906/es/foto/fondo-abstracto-triangular.jpg?b=1&s=170667a&w=0&k=20&c=UTL2PU75t1yyJB_C9ORFOsA7LgkvxIZncxK7A44gGGA='); background-size: cover;">
            ...
            <div class="ml-2 titulos">
                ...
                {{-- <div class="text-sm text-gray-500 dark:text-gray-400">Tasa del dia: {{ $tasa->tasa }}
            </div> --}}
        </div>
    </div>
    <div wire:click="gift()" class="cursor-pointer flex items-center border p-4 rounded-xl shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]" style="background-image: url('https://media.istockphoto.com/id/624878906/es/foto/fondo-abstracto-triangular.jpg?b=1&s=170667a&w=0&k=20&c=UTL2PU75t1yyJB_C9ORFOsA7LgkvxIZncxK7A44gGGA='); background-size: cover;">
...
<div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-2 px-3">
    ...
    <div onclick="Livewire.dispatch('openModal', { component: 'tasa-bcv' })" class="cursor-pointer p-6 rounded-lg" style="background-image: url('images/17.png'); background-size: 100% 100%;">
    ...
    {{-- Nomina --}}
    <div wire:click="valida_tasa({{ 10 }})" class="cursor-pointer p-6 rounded-lg" style="background-image: url('images/15.png');background-size: 100% 100%;">
        <div class="flex items-center">
        ...
        <div class="ml-12 text-right">
            ...
            <div class="mt-5 text-right text-xs font-semibold text-black">
    ...
    {{-- Reportes --}}
    <div wire:click="valida_tasa({{ 11 }})" class="cursor-pointer p-6 rounded-lg" style="background-image: url('images/4.png');background-size: 100% 100%;">
        <div class="flex items-center">
            <svg class="w-16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
