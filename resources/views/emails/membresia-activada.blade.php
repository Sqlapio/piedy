...
<body>
    ...
    <div style="margin: auto; width: 600px; padding: 10px;">
        ...
        <p style="text-align: justify; margin-left: 20px;">
            Se informa que la MEMBRESIA con el Nro. {{ $mailData['codigo_seguridad'] }}, acaba de ser activada. <br>
            A continuación el Detalle de la activación:
            <br>
            <br>
        ...
        <div style="margin: auto; width: 600px; padding: 10px;">
            <table id="customers">
                ...
                <tr>
                    <td>Referencia</td>
                    <td>{{ ($mailData['referencia'] != '') ? $mailData['referencia'] : 'N/A' }}</td>
                </tr>
            </table>
        </div>
        <p style="text-align: justify; margin-left: 20px;">
