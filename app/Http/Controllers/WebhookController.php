...
class WebhookController extends Controller
{
    ...
    public function webhookAgendarCita ($name, $phone, $fecha, $hora, $servicio_id) {
        ...
        {
            if (str_starts_with($phone, '0412') || str_starts_with($phone, '0414') || str_starts_with($phone, '0424') || str_starts_with($phone, '0416') || str_starts_with($phone, '0426')) {
                
                if (now()->format('Y-m-d') < date("Y-m-d", strtotime($fecha_api . "+ 15 days"))) {
