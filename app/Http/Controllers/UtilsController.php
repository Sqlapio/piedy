...
class UtilsController extends Controller
{
    ...
    static function cal_comision_giftCard($monto, $tipoSrv)
    {
        ...
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(cal_comision_giftCard)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
    ...
    static function cal_comision_empleado($valorUno, $valorDos, $tipoSrv, $tipoSrvID, $total_vista = null, $monto_giftcard = 0)
    {
        ...
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(cal_comision_empleado)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
                ->icon('heroicon-c-x-circle')
                ->color('danger')
    ...
    static function comiEmple_ventaProducto($costo)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(comiEmple_ventaProducto)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
                ->icon('heroicon-c-x-circle')
                ->color('danger')
    ...
    static function comiGerente_ventaProducto($costo)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(comiGerente_ventaProducto)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
                ->icon('heroicon-c-x-circle')
                ->color('danger')
    ...
    static function comiGerente_ventaProducto_directa($costo)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(comiGerente_ventaProducto_directa)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
                ->icon('heroicon-c-x-circle')
                ->color('danger')
    ...
    static function info($cod_asignacion)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(info)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
                ->icon('heroicon-c-x-circle')
                ->color('danger')
    ...
    static function restriccion_serv_vip($cod_asignacion)
    {
        ...
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(restriccion_serv_vip)', $th->getMessage(), $response = null);
            Notification::make()
                ->title('NOTIFICACIÓN')
                ->icon('heroicon-c-x-circle')
                ->color('danger')
    ...
    static function calculo_vip($quirop_basica, $srvs_adicional, $porcen_vip_emp, $porcen_adi_emp, $porcen_vip_gte)
    {
        ...
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(calculo_vip)', $th->getMessage(), $response = null);
            Notification::make()
    ...
    static function calculo_vip_bsd($quirop_basica, $srvs_adicional, $porcen_vip_emp, $porcen_adi_emp, $porcen_vip_gte)
    {
        ...
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(calculo_vip_bsd)', $th->getMessage(), $response = null);
            Notification::make()
    ...
    static function calculo_general($total_servicios, $porcen_comision_emp)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(calculo_general)', $th->getMessage(), $response = null);
            Notification::make()
    ...
    static function calculo_general_bsd($porcen_comision_emp, $costo_total_servicios)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(calculo_general_bsd)', $th->getMessage(), $response = null);
            Notification::make()
    ...
    static function calculo_general_multiple($monto_usb, $monto_bsd, $total_venta, $porcen_vip_emp, $costo_total_servicios)
    {
        try {
            ...
            LogController::log(Auth::user()->id, 'excepcion-UtilsController(calculo_general_multiple)', $th->getMessage(), $response = null);
            Notification::make()
