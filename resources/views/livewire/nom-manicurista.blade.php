<div>
    ...
    <div class="px-10 py-4">
        <div class="mb-10">
            <div class="flex">
                <h1 class="text-xl mb-6 font-extrabold text-[#7898a5] uppercase">MODULO DE NOMINA MANICURISTAS</h1>
            </div>
            <div class="flex">
    ...
    <div class="px-10 py-4">
        <div class="flex">
            <h1 class="text-sm mb-4 font-extrabold text-[#bd9c95] uppercase">tabla de nomina</h1>
        </div>
