    ...
    public static function cierreDiario($ref_debito, $monto_ref_debito, $ref_credito, $monto_ref_credito, $ref_visaMaster, $monto_ref_visaMaster, $observaciones = null)
    {
        ...
        try {
            ...
            if($query >= 2){
                ...
                $total_propinas_usd             = VentaServicio::where('fecha_venta', date('d-m-Y'))->sum('propina_usd');
                ...
                $total_propinas_bsd         = VentaServicio::where('fecha_venta', date('d-m-Y'))->sum('propina_bsd');
