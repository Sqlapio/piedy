<div>
    ...
    <div class="px-10 py-4">
        <div class="mb-10">
            <div class="flex">
                <h1 class="text-xl mb-6 font-extrabold text-[#7898a5] uppercase">MODULO DE CIERRE FINANCIERO</h1>
            </div>
            ...
            <div class="contenedor">
                ...
                <!-- Grid -->
                <div class="grid md:grid-cols-4 sm:gap-4 md:gap-4 mb-10 mt-10">
                    <!-- Fecha Ini -->
                    <div>
                    ...
                    <!-- Boton -->
                    <div class="mt-5">
                        <button type="submit" wire:click.prevent="notificacion_cierre()" class="w-full rounded-md border border-transparent bg-green-700 py-2 px-4 text-sm font-bold text-white shadow-sm hover:bg-check-green">
                            ...
                            <span>Ejecutar Cierre Financiero</span>
                        </button>
                    </div>
                </div>
            </div>
