            ...
            <div class="w-full max-h-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center gap-2">
                    ...
                    <div class="font-medium dark:text-white">
                        <div class="text-md text-green-500 font-extrabold dark:text-gray-400">Codigo de Venta: {{ $codigo }}</div>
                        <div class="text-md text-green-500 font-extrabold dark:text-gray-400">Nombre: {{ Auth::user()->name }}</div>
                        <div class="text-md text-green-500 font-extrabold dark:text-gray-400">Rol: {{ Auth::user()->tipo_usuario }}</div>
                    </div>
                </div>
                ...
                <ul class="my-4 space-y-3">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-2 px-5 text-base font-bold text-white rounded-lg bg-green-700 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)]">
                            ...
                            <span class="flex-1 ml-3 text-lg whitespace-nowrap">Total General de Venta:</span>
            ...
            <div class="w-full max-h-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul class="space-y-3">
                    ...
                    <div class="flex justify-between w-full">
                        <div class="flex-col w-2/3 p-2 rounded-lg bg-green-500 shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)]">
                        ...
                        <div class="w-3/12 mt-auto mb-auto">
